...
def load_data(partition):
    ...
    all_data = []
    all_label = []
    server_order = { 'train' : [4, 0, 2, 1, 3], 'test' : [1, 0] }
    for elem in server_order[partition]:
        h5_name = os.path.join(DATA_DIR, 'modelnet40_ply_hdf5_2048', f'ply_data_{partition}{elem}.h5')
